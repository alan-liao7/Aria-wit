...
export declare class FacebookProfileAPIClient {
     ...
     * @return
     */
    setGreetingMessage(greetingMessage: string, cb?: Function): Promise<{}> | undefined;
    /**
     ...
     * @return
     */
    setGetStartedAction(getStartedPayload: string, cb?: Function): Promise<{}> | undefined;
    /**
     ...
     * @return
     */
    setPersistentMenu(menuEntries: Object[], cb?: Function): Promise<{}> | undefined;
    private sendConfigurationMessage(payload, urlCrumb, cb?);
}
